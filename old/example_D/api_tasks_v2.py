...
parallelization_list = [
    dict(
        path="my_plate.zarr/A/01/0", subsets=dict(C_index=0)
    ),  # channel 0 of well A/01
    dict(
        path="my_plate.zarr/A/02/0", subsets=dict(C_index=0)
    ),  # channel 0 of well A/02
    dict(
        path="my_plate.zarr/A/02/0", subsets=dict(C_index=1)
    ),  # channel 1 of well A/02
]
